<x-layout>
    ...
    <section class=" bg-center bg-no-repeat bg-[url('C:\laragon\www\Portofolio\public\img\world.jpg')] bg-gray-700 bg-blend-multiply col-2">
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56"> 
          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Nico Fernando Sampe Tua Simanjuntak</h1>
